...
public interface IHotelController {
    ...
    @PreAuthorize("hasRole('GUEST')")
    public ApiResponseImpl<List<IHotel>> searchHotels(@PathVariable("cityName") String cityName );//, @RequestParam("fromDate") String from, @RequestParam("toDate") String to, @RequestParam("roomType") String roomType) throws ParseException;
}
